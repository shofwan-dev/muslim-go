...
<div class="container">
            ...
            <div class="col-12 mb-4">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <p class="arabic-text" style="font-family: 'Scheherazade', serif; font-size: 2rem; text-align: right;">{{ $hadith['arab'] }}</p>
                        <div class="translation-text">
                            @php
                                $paragraphs = explode('.', $hadith['id']); // Pisahkan berdasarkan titik
                            @endphp
                            @foreach(array_chunk($paragraphs, 2) as $chunk) <!-- Setiap 2 kalimat -->
    ...
    @else
        <p class="text-center text-muted">Tidak ada hadits yang tersedia.</p>
    @endif
</div>
@endsection